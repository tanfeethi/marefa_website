...
const faqList: FAQItem[] = [
    {
        ...
        answer: "You can register as a student from the website or app, then start browsing or enrolling in courses or creating learning pages."
    },
    {
        question: "Are the courses individual or group-based?",
        answer: "Courses can be both individual and group-based, depending on the course format."
    },
    {
        question: "Can I rewatch the lessons?",
        answer: "Yes, you can replay the lessons at any time during the course access period."
    },
    {
        question: "How do you ensure the quality of the instructors?",
        answer: "Instructors go through a vetting and training process to ensure quality and teaching effectiveness."
    },
    {
