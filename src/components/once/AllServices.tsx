...
const AllServices = () => {
    ...
    return (
        <section className="py-16 px-4 md:px-12 bg-white text-right">
            <WrapperContainer>
                <Header
                    title="ماذا"
                    subtitle="نُقدم؟"
                ...
                <p className="text-gray-600 text-end mb-10">
                    في "معرفة"، نقدم تجربة تعليمية متكاملة مصممة لتناسب احتياجات كل متعلم، من خلال دروس تفاعلية ذكية ودعم دائم، لتوجه إلى تمكين الطالب من التعلم بأسلوب مرن، ومتكامل سواء بشكل فردي أو ضمن مجموعة.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    <div className="w-full">
                        <img
                            ...
                            className="rounded-lg w-full h-auto object-cover transition duration-300 ease-in-out"
                        />
                    </div>
